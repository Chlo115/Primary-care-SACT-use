...
There were a total of `r formatC(total_items, big.mark=",")` occurrences of SACT being dispensed in Primary Care in England between 2019 and 2022, with a total expenditure of `r scales::dollar(total_cost, prefix="£", big.mark=",")`.
...
On `r sum(single_tablet$Quantity)` occasions a single dose of SACT was dispensed.
